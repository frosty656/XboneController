...
void ConfigFile::ExtractKeys()
{
	...
	if (!file)
	{
		...
		outfile << "CONFIG_SCROLL_SPEED = " << Scroll_Change << "	# Open System Keyboard" << std::endl;
		outfile << "\n" << std::endl;
		...
		outfile << "\n" << std::endl;
		outfile << "GAMEPAD_DPAD_UP = " << Dpad_Up << std::endl;
		outfile << "GAMEPAD_DPAD_DOWN = " <<Dpad_Down << std::endl;
		outfile << "GAMEPAD_DPAD_LEFT = " << Dpad_Left << std::endl;
		outfile << "GAMEPAD_DPAD_RIGHT = " << Dpad_Right << std::endl;
		outfile << "GAMEPAD_START = " << Start << std::endl;
		outfile << "GAMEPAD_BACK = " << Back << std::endl;
		outfile << "GAMEPAD_LEFT_THUMB = " << Left_Thumb << std::endl;
		outfile << "GAMEPAD_RIGHT_THUMB = " << Right_Thumb << std::endl;
		outfile << "GAMEPAD_LEFT_SHOULDER = " << Left_Shoulder << std::endl;
		outfile << "GAMEPAD_RIGHT_SHOULDER = " << Right_Shoulder << std::endl;
		outfile << "GAMEPAD_A = " << A << std::endl;
		outfile << "GAMEPAD_B = " << B << std::endl;
		outfile << "GAMEPAD_X = " << X << std::endl;
		outfile << "GAMEPAD_Y = " << Y << std::endl;
		outfile << "GAMEPAD_TRIGGER_LEFT = " << Trigger_Left << std::endl;
		outfile << "GAMEPAD_TRIGGER_RIGHT = " << Trigger_Right << std::endl;
		//end cfg dump
